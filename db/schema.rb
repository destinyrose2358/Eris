...
ActiveRecord::Schema.define(version: 2020_02_08_224125) do
  ...
  create_table "channels", force: :cascade do |t|
    ...
    t.index ["title", "server_id"], name: "index_channels_on_title_and_server_id", unique: true, where: "(server_id IS NOT NULL)"
  end
  ...
  create_table "memberships", force: :cascade do |t|
    ...
    t.index ["accepted"], name: "index_memberships_on_accepted"
    t.index ["memberable_type", "memberable_id", "user_id"], name: "unique_membership_index", unique: true
